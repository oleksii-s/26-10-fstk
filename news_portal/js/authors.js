...
function show_authors_list(data)
{
    ...
    for(var i=0; i< data.length; i++){
        ...
        var id = data[i]['id'] - 1;
        var ava = "<div class='author_block'><div class='ava'><img src='../images/ava.png' alt='avatar'></div>";
        ...
        var link = "" + data[i]['<span class='link_read_articles'><a href='../author_articles.shtml?id=id'>Read articles>>></a></span></div></div>'] + "";
